...
public class LazyProfessorClient : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.C))
            SendMessageToHost(ClientToServerTransferSignifiers.CreateAccount + ",101203253,123456");
        else if (Input.GetKeyDown(KeyCode.L))
            SendMessageToHost(ClientToServerTransferSignifiers.Login + ",101203253,abcde");
            ...
            SendMessageToHost(ClientToServerTransferSignifiers.SubmitDiscordUserName + ",qetup#7827");
        else if (Input.GetKeyDown(KeyCode.D))
            SendMessageToHost(ClientToServerTransferSignifiers.SubmitAssignmentOneLink + ",https://github.com/qetupjuan/SimplestClientDeGouveia.git");
        else if (Input.GetKeyDown(KeyCode.D))
            SendMessageToHost(ClientToServerTransferSignifiers.SubmitAssignmentTwoLink + ",https://github.com/qetupjuan/SimplestServerDeGouveia.git");
